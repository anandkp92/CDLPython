# ABOUTME: Greater than threshold comparison for integers
...
class GreaterThreshold(CDLBlock):
    ...
    def __init__(self, t: int = 0, **kwargs):
        """
        Initialize GreaterThreshold block.
    ...
    def compute(self, u: int) -> Dict[str, Any]:
        """
        Compare input against threshold for greater than.
