# ABOUTME: Less than or equal threshold comparison for integers
# ABOUTME: Outputs true if input <= threshold
from typing import Any, Dict
from cdl_python.base import CDLBlock


class LessEqualThreshold(CDLBlock):
    """
    Less than or equal threshold: y = (u <= t)
    ...
    def __init__(self, t: int = 0, **kwargs):
        """
        Initialize LessEqualThreshold block.
    ...
    def compute(self, u: int) -> Dict[str, Any]:
        """
        Compare input against threshold for less than or equal.
