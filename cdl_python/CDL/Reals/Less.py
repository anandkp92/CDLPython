# ABOUTME: Less block - compares two real inputs with optional hysteresis.
...
class Less(CDLBlock):
    """
    Output y is true if input u1 is less than input u2 with hysteresis.
    ...
    Outputs:
        y: True if u1 is less than u2 with hysteresis
