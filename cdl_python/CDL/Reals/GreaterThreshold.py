# ABOUTME: GreaterThreshold block - compares real input against threshold with optional hysteresis.
...
class GreaterThreshold(CDLBlock):
    """
    ...
    Outputs:
        y: True if u is greater than threshold with hysteresis
