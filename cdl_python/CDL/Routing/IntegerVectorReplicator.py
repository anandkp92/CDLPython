# ABOUTME: IntegerVectorReplicator - Replicate integer vector multiple times
from typing import Any, Dict, List
from cdl_python.base import CDLBlock


class IntegerVectorReplicator(CDLBlock):
    """Replicate integer vector nrep times
    ...
    def __init__(self, nin: int = 1, nrep: int = 1):
        """Initialize IntegerVectorReplicator block
