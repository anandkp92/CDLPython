# ABOUTME: IntegerVectorFilter - Filter integer vector by boolean mask
from typing import Any, Dict, List
from cdl_python.base import CDLBlock


class IntegerVectorFilter(CDLBlock):
    """Filter integer vector by boolean mask

    Filters input vector by keeping only elements where mask is True.
    Example: u=[1,2,3,4], msk=[True,False,True,False] → y=[1,3]
    """

    def __init__(self, nin: int, nout: int, msk: List[bool] = None):
        """Initialize IntegerVectorFilter block
