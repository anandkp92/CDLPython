# ABOUTME: BooleanExtractSignal - Extract scalar from boolean vector by index parameter
from typing import Any, Dict, List
from cdl_python.base import CDLBlock


class BooleanExtractSignal(CDLBlock):
    """Extract scalar from boolean vector by index parameter
    ...
    def __init__(self, nin: int = 1, extract: int = 1):
        """Initialize BooleanExtractSignal block
